...
if(mysqli_num_rows($result_cust)>0){
  echo '<div class="alert alert-warning" role="alert"><span class="glyphicon glyphicon-warning-sign"></span>  Alerta! Tienes una Reserva pendiente <span class="glyphicon glyphicon-warning-sign"></span> </div>';
}else{
        ...
        if (mysqli_num_rows($result_avail)>0) {
              ...
              echo "Espacio Reservado";
                ...
                echo "No se pudo reservar el espacio";
              }
