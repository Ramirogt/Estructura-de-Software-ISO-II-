...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    ...
    <button class="btn btn-default" type="button" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">Seleccionar</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
          <li class="list-group-item"><span class="glyphicon glyphicon-home"></span> <?=$parking_name; ?></li>
          <li class="list-group-item"><span class="glyphicon glyphicon-tags"></span> <?=$parking_slot; ?> Espacios Disponibles </li>
          <li class="list-group-item"><span class="glyphicon glyphicon-tag"></span> <?=$parking_slot; ?> Espacios restantes</li>
          <li class="list-group-item"><span class="glyphicon glyphicon-credit-card"></span> Bs. <?=$parking_price; ?> Espacio por Hora</li>
          <li class="list-group-item total"  ><div id="total<?=$parking_id; ?>"> Bs.<?=$parking_slot; ?> Costo Total</div></li>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Seleccionar Espacio</button>
      </div>
    </div>
  </div>
</div>
