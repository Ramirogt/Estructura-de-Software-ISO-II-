...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    ...
    <button class="btn btn-default" data-backdrop="false" type="button" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">Seleccionar</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
          ...
          <li class="list-group-item"><span class="glyphicon glyphicon-tag"></span> <?=$parking_remaining; ?> Espacios Restantes</li>
          <li class="list-group-item"><span class="glyphicon glyphicon-credit-card"></span> Bs. <?=$parking_price; ?> Espacio por hora</li>
          <li class="list-group-item " ><span class="glyphicon">Bs. </span> <p class="total" id="total<?=$parking_id; ?>"><?=$parking_slot; ?> </p></li>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="select<?=$parking_id; ?>">Seleccionar Espacio</button>
      </div>
    </div>
  </div>
</div>
...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    ...
    <button class="btn btn-default" type="button" data-backdrop="false" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">Seleccionar</button>
...
<div class="modal fade parking_text" id="reserve<?=$parking_id ; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><?=$parking_name; ?> Reservaciones</h4>
      </div>
      <div class="modal-body">
        <ul class="list-group">
          <li class="list-group-item"><span class="glyphicon glyphicon-home"></span> <?=$parking_name; ?></li>
          ...
          <li class="list-group-item"><span class="glyphicon glyphicon-credit-card"></span> Bs. <?=$parking_price; ?> Espacios por hora</li>
          <li class="list-group-item " ><span class="glyphicon">Bs. </span> <p class="total" id="total<?=$parking_id; ?>"><?=$parking_slot; ?> </p></li>

          </li>
          <li class="list-group-item">
            <div class="input-group">
              <input type="text" class="form-control"  id="hour<?=$parking_id; ?>" placeholder="Cantidad de Horas" aria-describedby="basic-addon2">
